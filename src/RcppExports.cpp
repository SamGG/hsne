...
// my_annoy
void my_annoy(Rcpp::NumericMatrix mat, int K);
RcppExport SEXP _hsne_my_annoy(SEXP matSEXP, SEXP KSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _hsne_run(SEXP nmSEXP, SEXP num_scalesSEXP, SEXP seedSEXP, SEXP landmark_thresholdSEXP, SEXP num_neighborsSEXP, SEXP num_treesSEXP, SEXP num_checksSEXP, SEXP transition_matrix_prune_threshSEXP, SEXP num_walksSEXP, SEXP num_walks_per_landmarkSEXP, SEXP monte_carlo_samplingSEXP, SEXP out_of_core_computationSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_hsne_my_annoy", (DL_FUNC) &_hsne_my_annoy, 2},
    {"_hsne_run", (DL_FUNC) &_hsne_run, 12},
    {NULL, NULL, 0}
};

RcppExport void R_init_hsne(DllInfo *dll) {
